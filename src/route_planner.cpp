...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    RouteModel::Node* node_pointer = current_node;
    while (node_pointer->parent != nullptr) {
        path_found.push_back(*node_pointer);
        distance += node_pointer->distance(*node_pointer->parent);
